...
elseif(${HOSTNAME} STREQUAL  "fedora23-BigScreen")
  message(STATUS "Using fedora23-BigScreen optimisation options")
  ...
  # work around to use gcc-4.4 instead of 4.5
  #set(CUDA_NVCC_EXECUTABLE "/home/rodrigob/code/references/cuda/gcc-4.4/nvcc-4.4.sh")
  set(CUDA_NVCC_FLAGS ${CUDA_NVCC_FLAGS} -arch=sm_30)  ## is this parametr correct?
  ...
  set(liblinear_INCLUDE_DIRS "/home/chris/workspace/100fps/doppia/libs/liblinear-1.8")
  set(liblinear_LIBRARY_DIRS "/home/chris/workspace/100fps/doppia/libs/liblinear-1.8")
